...
type InMemConsignmentRepository struct {
	consignments []*pb.Consignment
}

func (repo *InMemConsignmentRepository) Create(consignment *pb.Consignment) error {
	repo.consignments = append(repo.consignments, consignment)
	return nil
}

func (repo *InMemConsignmentRepository) GetAll() ([]*pb.Consignment, error) {
	return repo.consignments, nil
}

func (repo *InMemConsignmentRepository) Close() {}
